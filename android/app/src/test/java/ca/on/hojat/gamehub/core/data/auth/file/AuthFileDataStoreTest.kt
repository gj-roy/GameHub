package ca.on.hojat.gamehub.core.data.auth.file

import androidx.datastore.core.DataStore
import ca.on.hojat.gamehub.core.data.auth.datastores.file.ProtoAuthMapper
import ca.on.hojat.gamehub.core.providers.TimestampProvider
import ca.on.hojat.gamehub.core.data.DOMAIN_OAUTH_CREDENTIALS
import ca.on.hojat.gamehub.core.data.auth.datastores.file.AuthExpiryTimeCalculator
import ca.on.hojat.gamehub.core.data.auth.datastores.file.AuthFileDataStore
import ca.on.hojat.gamehub.core.data.auth.datastores.file.NewProtoOauthCredentials
