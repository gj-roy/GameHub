package ca.on.hojat.gamehub.core.data.games.igdb

import ca.on.hojat.gamehub.core.data.api.ApiErrorMapper
import ca.on.hojat.gamehub.core.data.api.igdb.games.entities.ApiGame
import ca.on.hojat.gamehub.core.data.api.igdb.games.GamesEndpoint
import ca.on.hojat.gamehub.core.data.games.datastores.GamesIgdbDataSource
import ca.on.hojat.gamehub.core.data.games.datastores.IgdbGameMapper
import ca.on.hojat.gamehub.core.data.DOMAIN_COMPANY
import ca.on.hojat.gamehub.core.data.FakeDiscoveryGamesReleaseDatesProvider
import ca.on.hojat.gamehub.core.data.games.datastores.mapToDomainGames
import ca.on.hojat.gamehub.core.common_testing.API_ERROR_HTTP
import ca.on.hojat.gamehub.core.common_testing.API_ERROR_NETWORK
import ca.on.hojat.gamehub.core.common_testing.API_ERROR_UNKNOWN
import ca.on.hojat.gamehub.core.common_testing.domain.DOMAIN_GAME
import ca.on.hojat.gamehub.core.common_testing.domain.MainCoroutineRule
import ca.on.hojat.gamehub.core.common_testing.domain.PAGINATION
...
internal class GamesIgdbDataSourceTest {
