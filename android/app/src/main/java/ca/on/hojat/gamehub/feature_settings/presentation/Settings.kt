...
import ca.on.hojat.gamehub.presentation.theme.subtitle3
...
import ca.on.hojat.gamehub.presentation.widgets.GameHubCard
import ca.on.hojat.gamehub.presentation.widgets.GameHubProgressIndicator
import ca.on.hojat.gamehub.presentation.widgets.dialogs.GameHubDialog
import ca.on.hojat.gamehub.presentation.widgets.toolbars.Toolbar
import ca.on.hojat.gamehub.core.extensions.showShortToast
import ca.on.hojat.gamehub.feature_settings.domain.entities.Language
...
private fun ThemePickerDialog(
    ...
    GameHubDialog(onDialogDismissed = onPickerDismissed) {
        Text(
