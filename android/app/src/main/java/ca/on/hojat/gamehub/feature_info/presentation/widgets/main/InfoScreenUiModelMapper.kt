...
import ca.on.hojat.gamehub.feature_info.domain.entities.InfoScreenData
import ca.on.hojat.gamehub.feature_info.presentation.widgets.companies.InfoScreenCompanyUiModelMapper
import ca.on.hojat.gamehub.feature_info.presentation.widgets.details.InfoScreenDetailsUiModelMapper
import ca.on.hojat.gamehub.feature_info.presentation.widgets.header.InfoScreenHeaderUiModelMapper
import ca.on.hojat.gamehub.feature_info.presentation.widgets.links.InfoScreenLinkUiModelMapper
import ca.on.hojat.gamehub.feature_info.presentation.widgets.relatedgames.RelatedGamesUiModel
import ca.on.hojat.gamehub.feature_info.presentation.widgets.relatedgames.mappers.InfoScreenOtherCompanyGamesUiModelMapper
import ca.on.hojat.gamehub.feature_info.presentation.widgets.relatedgames.mappers.InfoScreenSimilarGamesUiModelMapper
import ca.on.hojat.gamehub.feature_info.presentation.widgets.screenshots.InfoScreenShotUiModelMapper
import ca.on.hojat.gamehub.feature_info.presentation.widgets.videos.InfoScreenVideoUiModelMapper
