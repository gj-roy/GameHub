...
import ca.on.hojat.gamehub.CommandsHandler
import ca.on.hojat.gamehub.LocalUrlOpener
import ca.on.hojat.gamehub.NavBarColorHandler
import ca.on.hojat.gamehub.RoutesHandler
import ca.on.hojat.gamehub.core.events.Route
import ca.on.hojat.gamehub.presentation.theme.GameHubTheme
import ca.on.hojat.gamehub.presentation.widgets.AnimatedContentContainer
import ca.on.hojat.gamehub.presentation.widgets.FiniteUiState
import ca.on.hojat.gamehub.presentation.widgets.GameHubProgressIndicator
import ca.on.hojat.gamehub.presentation.widgets.Info
import ca.on.hojat.gamehub.presentation.widgets.categorypreview.GamesCategoryPreview
import ca.on.hojat.gamehub.core.extensions.showShortToast
import ca.on.hojat.gamehub.feature_info.presentation.InfoScreenCommand
import ca.on.hojat.gamehub.feature_info.presentation.InfoScreenViewModel
import ca.on.hojat.gamehub.feature_info.presentation.widgets.InfoScreenSummary
import ca.on.hojat.gamehub.feature_info.presentation.widgets.companies.InfoScreenCompanies
import ca.on.hojat.gamehub.feature_info.presentation.widgets.companies.InfoScreenCompanyUiModel
import ca.on.hojat.gamehub.feature_info.presentation.widgets.details.InfoScreenDetails
import ca.on.hojat.gamehub.feature_info.presentation.widgets.details.InfoScreenDetailsUiModel
import ca.on.hojat.gamehub.feature_info.presentation.widgets.header.InfoScreenHeader
import ca.on.hojat.gamehub.feature_info.presentation.widgets.header.InfoScreenHeaderUiModel
import ca.on.hojat.gamehub.feature_info.presentation.widgets.header.artworks.InfoScreenArtworkUiModel
import ca.on.hojat.gamehub.feature_info.presentation.widgets.links.InfoScreenLinkUiModel
import ca.on.hojat.gamehub.feature_info.presentation.widgets.links.InfoScreenLinks
import ca.on.hojat.gamehub.feature_info.presentation.widgets.relatedgames.RelatedGameUiModel
import ca.on.hojat.gamehub.feature_info.presentation.widgets.relatedgames.RelatedGamesType
import ca.on.hojat.gamehub.feature_info.presentation.widgets.relatedgames.RelatedGamesUiModel
import ca.on.hojat.gamehub.feature_info.presentation.widgets.relatedgames.mapToCategoryUiModels
import ca.on.hojat.gamehub.feature_info.presentation.widgets.relatedgames.mapToInfoRelatedGameUiModel
import ca.on.hojat.gamehub.feature_info.presentation.widgets.screenshots.InfoScreenShotSection
import ca.on.hojat.gamehub.feature_info.presentation.widgets.screenshots.InfoScreenShotUiModel
import ca.on.hojat.gamehub.feature_info.presentation.widgets.videos.InfoScreenVideoSection
...
private fun LoadingState(modifier: Modifier) {
    GameHubProgressIndicator(modifier = modifier)
}
