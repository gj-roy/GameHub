...
import ca.on.hojat.gamehub.core.data.api.igdbcalypse.querybuilder.ApicalypseQueryBuilderFactory
import ca.on.hojat.gamehub.core.data.api.igdb.games.entities.ApiGame
import ca.on.hojat.gamehub.core.data.api.igdb.games.entities.ApiGame.Schema.HYPE_COUNT
import ca.on.hojat.gamehub.core.data.api.igdb.games.entities.ApiGame.Schema.ID
import ca.on.hojat.gamehub.core.data.api.igdb.games.entities.ApiGame.Schema.RELEASE_DATE
import ca.on.hojat.gamehub.core.data.api.igdb.games.entities.ApiGame.Schema.TOTAL_RATING
import ca.on.hojat.gamehub.core.data.api.igdb.games.entities.ApiGame.Schema.USERS_RATING
import ca.on.hojat.gamehub.core.data.api.igdb.games.requests.GetComingSoonGamesRequest
import ca.on.hojat.gamehub.core.data.api.igdb.games.requests.GetGamesRequest
import ca.on.hojat.gamehub.core.data.api.igdb.games.requests.GetMostAnticipatedGamesRequest
import ca.on.hojat.gamehub.core.data.api.igdb.games.requests.GetPopularGamesRequest
import ca.on.hojat.gamehub.core.data.api.igdb.games.requests.GetRecentlyReleasedGamesRequest
import ca.on.hojat.gamehub.core.data.api.igdb.games.requests.SearchGamesRequest
import ca.on.hojat.gamehub.core.data.api.igdbcalypse.serialization.ApicalypseSerializer
