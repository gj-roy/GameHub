...
import com.paulrybitskyi.gamedge.feature_info.presentation.widgets.companies.GameInfoCompanyUiModelMapper
import com.paulrybitskyi.gamedge.feature_info.presentation.widgets.companies.mapToUiModels
import com.paulrybitskyi.gamedge.feature_info.presentation.widgets.details.GameInfoDetailsUiModelMapper
import com.paulrybitskyi.gamedge.feature_info.presentation.widgets.header.GameInfoHeaderUiModelMapper
import com.paulrybitskyi.gamedge.feature_info.presentation.widgets.links.GameInfoLinkUiModelMapper
import com.paulrybitskyi.gamedge.feature_info.presentation.widgets.relatedgames.GameInfoRelatedGamesUiModel
import com.paulrybitskyi.gamedge.feature_info.presentation.widgets.relatedgames.mappers.GameInfoOtherCompanyGamesUiModelMapper
import com.paulrybitskyi.gamedge.feature_info.presentation.widgets.relatedgames.mappers.GameInfoSimilarGamesUiModelMapper
import com.paulrybitskyi.gamedge.feature_info.presentation.widgets.screenshots.GameInfoScreenshotUiModelMapper
import com.paulrybitskyi.gamedge.feature_info.presentation.widgets.screenshots.mapToUiModels
import com.paulrybitskyi.gamedge.feature_info.presentation.widgets.videos.GameInfoVideoUiModelMapper
import com.paulrybitskyi.gamedge.feature_info.presentation.widgets.videos.mapToUiModels
