...
import ca.on.hojat.gamenews.shared.commons.ktx.clearEndMargin
import ca.on.hojat.gamenews.shared.commons.ktx.endMargin
import ca.on.hojat.gamenews.shared.commons.ktx.getColor
import ca.on.hojat.gamenews.shared.commons.ktx.getDimension
...
import ca.on.hojat.gamenews.shared.commons.ktx.onClick
import ca.on.hojat.gamenews.shared.commons.ktx.setColor
import ca.on.hojat.gamenews.shared.commons.ktx.setHorizontalPadding
import ca.on.hojat.gamenews.shared.commons.ktx.setLayoutParamsSize
import ca.on.hojat.gamenews.shared.commons.ktx.updatePadding
import ca.on.hojat.gamenews.shared.commons.ktx.verticalPadding
...
class Toolbar @JvmOverloads constructor(
    ...
    private fun extractAttributes(attrs: AttributeSet, defStyleAttr: Int) {
        context.withStyledAttributes(
            ...
            titleTextGravity =
                getInt(R.styleable.CustomToolbar_toolbar_titleTextGravity, titleTextGravity.id)
                    .asTitleGravity()
        }
    }
