package ca.on.hojat.gamehub.core.data.database

import androidx.room.Database
import androidx.room.RoomDatabase
import androidx.room.TypeConverters
import ca.on.hojat.gamehub.core.data.database.articles.ArticlesTable
import ca.on.hojat.gamehub.core.data.database.articles.ArticlesTypeConverter
import ca.on.hojat.gamehub.core.data.database.articles.DbArticle
import ca.on.hojat.gamehub.core.data.database.games.GamesTypeConverter
