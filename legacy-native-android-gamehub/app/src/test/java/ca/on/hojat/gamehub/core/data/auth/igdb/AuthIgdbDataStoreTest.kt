package ca.on.hojat.gamehub.core.data.auth.igdb

import ca.on.hojat.gamehub.core.data.api.ApiErrorMapper
import ca.on.hojat.gamehub.core.data.api.igdb.auth.entities.ApiOauthCredentials
import ca.on.hojat.gamehub.core.data.api.igdb.auth.AuthEndpoint
import ca.on.hojat.gamehub.core.data.auth.datastores.igdb.AuthIgdbDataStore
import ca.on.hojat.gamehub.core.data.auth.datastores.igdb.IgdbAuthMapper
