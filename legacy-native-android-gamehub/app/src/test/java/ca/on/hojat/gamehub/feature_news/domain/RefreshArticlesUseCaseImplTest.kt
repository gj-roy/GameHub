package ca.on.hojat.gamehub.feature_news.domain

import app.cash.turbine.test
import ca.on.hojat.gamehub.feature_news.DOMAIN_ARTICLES
import ca.on.hojat.gamehub.core.common_testing.domain.DOMAIN_ERROR_UNKNOWN
import ca.on.hojat.gamehub.core.common_testing.domain.MainCoroutineRule
import ca.on.hojat.gamehub.core.common_testing.domain.coVerifyNotCalled
import com.github.michaelbull.result.Err
import com.github.michaelbull.result.Ok
import com.github.michaelbull.result.get
import com.google.common.truth.Truth.assertThat
import ca.on.hojat.gamehub.feature_news.domain.throttling.ArticlesRefreshingThrottler
import ca.on.hojat.gamehub.feature_news.domain.throttling.ArticlesRefreshingThrottlerKeyProvider
import ca.on.hojat.gamehub.feature_news.domain.throttling.ArticlesRefreshingThrottlerTools
import ca.on.hojat.gamehub.feature_news.domain.usecases.RefreshArticlesUseCase
import ca.on.hojat.gamehub.feature_news.domain.usecases.RefreshArticlesUseCaseImpl
import ca.on.hojat.gamehub.feature_news.domain.repository.ArticlesRepository
import ca.on.hojat.gamehub.feature_news.domain.repository.ArticlesLocalDataSource
import ca.on.hojat.gamehub.feature_news.domain.repository.ArticlesRemoteDataSource
